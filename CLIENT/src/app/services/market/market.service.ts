...
export class MarketService {
  ...
  addLike(idmarket?:string):Observable<any>{
    return this.http.put(`${this.UserService.url}/addlike`,{idmarket});
  }
  addDisLike(idmarket?:string):Observable<any>{
    return this.http.put(`${this.UserService.url}/notlike`,{idmarket});
  }
